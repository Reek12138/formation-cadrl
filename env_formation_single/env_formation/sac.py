...
class PolicyNetwork(nn.Module):
    def __init__(self, state_dim, hidden_dim, action_dim, n_head=4, d_dim=32, self_dim=64):
...
class QvalueNet(nn.Module):
    def __init__(self, multi_state_dim, multi_hidden_dim, multi_action_dim, n_head=4, d_dim=32, self_dim=64):
